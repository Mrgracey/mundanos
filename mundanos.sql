...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-11-2019 a las 00:18:13
...
CREATE TABLE `user` (
  ...
  `tf_active` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1="activo" 0="inactivo"'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `user` (`id`, `email`, `user`, `password`, `type`, `tf_active`) VALUES
(1, 'mundanos1609@gmail.com', 'admin', '1609', 'admin', 1),
(7, 'martingracey@hotmail.com', 'as', 'as', 'user', 1);
