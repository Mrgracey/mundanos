            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase mb-0">Editar usuario</h5>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label for="inp" class="inp">
                                                        <input type="text" value="'. $row['user'].'" name="user" id="inp" placeholder="Nombre de usuario">
                                                ...
                                                <td>
                                                    <label for="inp" class="inp">
                                                        <input type="text" value="'. $row['password'].'" name="password" id="inp" placeholder="Contraseña">
                                                        <span class="label"></span>
                                                        <span class="border"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label for="inp" class="inp">
                                                        <input type="text" value="'. $row['email'].'" name="email" id="inp" placeholder="ejemplo@mail.com">
                                                        <span class="label"></span>
                                                        <span class="border"></span>
                                                    </label>
                                                </td>
