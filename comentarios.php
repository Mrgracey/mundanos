                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <table class="table no-wrap user-table mb-0 sortable">
                                  ...
                                  <tbody>
                                    ...
                                    echo '<tr>
                                        ...
                                        <form action="CRUDcomments/update_comment.php?id='.$A_row['id'].'" method="post" enctype="multipart/form-data">
                                        <td>
                                            <button type="submit" name="submit" class="btn btn-outline-info btn-circle btn-lg btn-circle ml-2"><i class="fa fa-ellipsis-h"></i> </button>
                                        </td>
                                        </form>
                                    </tr>';
                                }
                            ...
                            <div style="padding: 1vh 85vh; margin: auto; display: flex; flex-wrap: wrap;">
                                
                                <?php
                                for ($i=1; $i <= $tope; $i++) {
                                        echo '
                                        <div style="margin: 0 1vh 0 1vh;">
                                            <a href="comentarios.php?pag='.$i.'">
