...
<body data-theme="dark">
    <?php
        ...
        $id=$_GET['id'];
        $query = mysqli_query($con, "SELECT * FROM comments WHERE id='$id' ");
                        ...
                        <li class="sidebar-item selected">
                            ...
                            <ul aria-expanded="false" class="collapse first-level in">
                                ...
                                <li class="sidebar-item active">
                                    <a href="../comentarios.php" class="sidebar-link active">
                                                        ...
                                                        <?php
                                                            ...
                                                            // }
                                                                while( $A_row=mysqli_fetch_array($query)){
                                                                    ...
                                                                    echo    '<form action="U_comment_mysql.php" method="post">
                                                                                <input type="hidden" name="id" value="'.$id.'">
                                                                                <label style="float: left; display: inline;" for="inp" class="inp">
                                                                                    <input style="border: none;" class="text-muted" type="text" disabled value="'. ucfirst(utf8_encode($A_row['name'])).'" name="title" id="inp" placeholder="Titulo">
                                                                                </label>
                                                                                <label style="float: right; display: inline;" class="switch">';
                                                                                    if ($A_row['tf_moderate']==1) {
                                                                                        echo   '<input type="checkbox" name="tf_moderate" value="1" checked>';
                                                                                    }else{
                                                                                        echo   '<input type="checkbox" name="tf_moderate" value="1" >';
                                                                                    }
